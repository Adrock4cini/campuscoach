                  ...
                  >
                    <div className="space-y-3">
                      ...
                      <div className="flex gap-3 rounded-xl border border-primary/20 bg-primary/5 p-3 text-sm">
                        ...
                        <p className="text-muted-foreground"><span className="font-medium text-foreground">Syllabi come after class setup.</span> Open any class and tap Add syllabus. We’ll review its homework, quizzes, tests, and study topics with you.</p>
                      </div>
                    </div>
                  </StepShell>
                )}
