...
-- Reset only affected concepts to exposure; immutable attempt/session ledgers
-- remain available for audit, while future verified work can rebuild mastery.
...
begin
  ...
  insert into public.user_concept_mastery (
    ...
    p_user_id, v_practice_concept_id, v_capture.class_id, 0.15, 0, 0,
    now(), now(), 0
  )
