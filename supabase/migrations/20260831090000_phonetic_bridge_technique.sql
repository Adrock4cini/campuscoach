-- Phonetic / wordplay bridges become a first-class mnemonic technique.
-- Additive and idempotent: the feedback constraint and the feedback RPC accept
-- the new 'phonetic_bridge' value so a student can rate a wordplay cue.
-- No data is modified.
