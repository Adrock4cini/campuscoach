...
export const STRATEGY_CATALOG: readonly Strategy[] = [
  ...
  {
    id: "phonetic-bridge",
    label: "Wordplay memory bridge",
    modality: "association",
    technique: "phonetic_bridge",
    actionLabel: "Make a wordplay bridge",
    taskKinds: ["memorize-terms"],
    subjects: [],
    whenToUse: "A paired fact (place and capital, term and meaning, word and translation) where one sound can cue the prompt and another can cue the answer.",
    avoidWhen: "The sounds do not genuinely overlap, or the wordplay could be read as the real word origin.",
    cost: "ai",
    safety: "Always label the sentence as an invented memory cue, never as etymology, history, or definition.",
    requiresGroundedSource: true,
  },
  {
    id: "familiar-bridge",
